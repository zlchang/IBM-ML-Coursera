...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class',
        title='Launch success counts at {}'.format(entered_site))
        return fig
...
def get_scatter_chart(entered_site, entered_payload):
    ...
    if entered_site == 'ALL':
        ...
        # return the outcomes piechart for a selected site
        data = filtered_df.loc[(spacex_df['Payload Mass (kg)'] > entered_payload[0]) & (spacex_df['Payload Mass (kg)'] < entered_payload[1])]
        fig = px.scatter(data, x='Payload Mass (kg)', y = 'class',
        color='Booster Version Category',
        title='Launch success vs. payload mass at {}'.format(entered_site))
        return fig
