...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'textAligh':'center','color':'#503D36', 'font-size':24}),#Include style for title
...
def update_output_container(selected_statistics, input_year):
    #print(input_year, selected_statistics)
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        x='Year',
        y='Automobile_Sales',
        title='Yearly Automobile sales in'))
