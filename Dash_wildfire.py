...
app.layout = html.Div(children=[html.H1('Australia Wildfire Dashboard', style={'textAlign':'center', 'color':'#503D36', 'text-font':26}),
...
#outer division starts
     html.Div([
                   # First inner divsion for  adding dropdown helper text for Selected Drive wheels
                    ...
                    html.Div([
                        html.H2('Select Year:', style={'margin-right': '2em','font-size':18}),
